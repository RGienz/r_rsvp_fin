...
onMounted(() => {
  // Declare scrollTimeout with explicit type
  let scrollTimeout: number | null = null; // FIX: Added type annotation and initialization
  ...
  const observer = new IntersectionObserver(
    (entries) => {
      ...
      // Iterate through entries to find the most prominent intersecting section
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
  ...
  window.addEventListener('scroll', () => {
    if (scrollTimeout !== null) { // Clear existing timeout if any
    ...
    scrollTimeout = setTimeout(() => {
      ...
      scrollTimeout = null; // Reset timeout ID after it's executed
    }, 100);
  }, { passive: true });
                  ...
                  <div class="w-sm h-full relative">
                    ...
                    <div v-if="item.id === 'home-section'">
                        <div class="relative w-full max-w-7xl mx-auto py-12 px-6">
                            <!-- <h1 class="text-5xl font-extrabold text-gray-900 mb-12 animate-fade-in-down">
                                Angela's 18th Birthday
                            </h1> -->
                            <h1 class="text-5xl font-extrabold text-gray-900 mb-12 animate-fade-in-down font-allura">
                                Angela's 18th Birthday
                            </h1>
