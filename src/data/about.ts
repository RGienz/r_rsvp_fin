...
<h2 class="text-4xl md:text-5xl font-extrabold text-white-800 mb-12 relative animate-slide-in-right">
  About Us
  <span class="block w-20 h-1 bg-gradient-to-r from-orange-500 to-red-500 mx-auto mt-4 rounded-full"></span>
</h2>
<div class="max-w-3xl text-center text-lg text-white-700 leading-relaxed space-y-6 animate-fade-in">
  <p>
